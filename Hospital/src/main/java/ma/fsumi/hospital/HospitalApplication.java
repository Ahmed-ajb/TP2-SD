package ma.fsumi.hospital;


import ma.fsumi.hospital.entities.*;
...
import ma.fsumi.hospital.service.IHospitalService;
...
public class HospitalApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		/*Stream.of("Ahmed","Anas", "Roba" , "Yassine").forEach(name->{
		...
		Stream.of("Ahmed","Rachid", "Nadim" , "Youssef").forEach(name->{
		...
		Patient patient = patientRepository.findByNom("Rachid");
		Medecin medecin = medecinRepository.findByNom("Yassin");
	...
	patientRepository.save(new Patient(null,"Ahmed", new Date(), true, 75));
		patientRepository.save(new Patient(null,"Anas", new Date(), false, 0));
		patientRepository.save(new Patient(null,"Rachid", new Date(), true, 10));
